...
const tradeableCashflowAddress = "0x81dE36394442EeADf3AAd0A835f99bEC45B55789"; //hardcoded address
//your address here:
...
async function main() {
  ...
  const userData = web3.eth.abi.encodeParameter('string', 'ipfs://QmUByUAWKua3haPevYdUNiVHbUGqhV23KGXaWQR1hgufoy/1.json');
